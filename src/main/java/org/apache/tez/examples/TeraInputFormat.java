...
public class TeraInputFormat extends FileInputFormat<Text,Text> {
  ...
  public static final String NUM_PARTITIONS = "mapreduce.terasort.num.partitions";
  public static final String SAMPLE_SIZE = "mapreduce.terasort.partitions.sample";
   ...
   */
  public static void writePartitionFile(final JobContext job, Path partFile, int numPartitions) throws Throwable  {
  ...
  public List<InputSplit> getSplits(JobContext job) throws IOException {
    ...
    if (job.getConfiguration().getBoolean(TeraScheduler.USE_TERA_SCHEDULER, true)) {
